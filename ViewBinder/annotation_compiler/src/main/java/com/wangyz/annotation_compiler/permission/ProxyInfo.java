package com.wangyz.annotation_compiler.permission;
...
public class ProxyInfo {
    ...
    public String generateJavaCode() {
        ...
        // TODO: 注意导包,注解包+permission-lib的
        builder.append("import com.wangyz.annotation.permission.*;\n");
        builder.append("import com.circle.permission.*;\n");
        builder.append('\n');
    ...
    public String toString() {
        return "ProxyInfo{" +
                ...
                ", grantMethodMap=" + grantMethodMap +
                ", deniedMethodMap=" + deniedMethodMap +
                ", rationaleMethodMap=" + rationaleMethodMap +
                '}';
    }
}